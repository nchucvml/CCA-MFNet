...
### 224x224
# DATA_LIST_PATH = './dataset/list/gastric_dataset/test_224x224.lst'
DATA_LIST_PATH = ''
...
def main():
    ...
    with Engine(custom_parser=parser) as engine:
        ...
        model.eval()
        dataset = GastricBinarySegDataSet(args.data_dir, args.data_list, crop_size=(224, 224), mean=IMG_MEAN, scale=False, mirror=False)  # 20220630
        ...
        # palette color order is 'RGB'. Three numbers are a set. For example: label index 0 is Non_IM (0, 0, 0), label index 1 is IM (0, 0, 255), label index other is IM (255, 0, 0)
